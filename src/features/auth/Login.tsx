...
// Professional modern login page with stunning design
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Pick up where you left off. Connect with skilled individuals,
                learn new abilities, and share your expertise.
              </p>
            </div>
